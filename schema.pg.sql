...
CREATE TABLE IF NOT EXISTS pincode (
    ...
    min_lat DOUBLE PRECISION, min_lon DOUBLE PRECISION, max_lat DOUBLE PRECISION, max_lon DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS locality (
    locality_id     BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE OR REPLACE VIEW v_pincode_lookup AS
SELECT p.pincode,
...
CREATE OR REPLACE VIEW v_pincode_offices AS
...
CREATE OR REPLACE VIEW v_pincode_localities AS
SELECT lp.pincode,
       l.locality_name,
       l.locality_type,
       l.district_id,
